                    ...
                    <div class="col-lg-6 col-md-6">
                        <div class="cart-summary">
                            ...
                            <ul class="summary-list">
                                <li>{{ __('Subtotal') }}
                                    <span>{{ currencyConverter((floatval(str_replace(',', '', \Cart::subtotal()))))}}</span>
                                </li>
                                <li>{{ __('Shipping Cost') }} <span id="delivery-charge-curr"></span></li>
                                <li>{{ __('VAT/Tax ') }} <span
                                        id="tax-show-curr">{{ tax_amount(\Cart::subtotal())}}</span>
                                </li>
                            ...
                            <div class="total-amount">
                                <h3>
                                    ...
                                    <span class="float-right" id="total-cost-curr">
                                       {{ currencyConverter((floatval(str_replace(',', '', \Cart::subtotal())))+floatval(allsetting()['shipping_charge']) + floatval(tax_amount(\Cart::subtotal())) - floatval(Session::get('CouponAmount')))}}
